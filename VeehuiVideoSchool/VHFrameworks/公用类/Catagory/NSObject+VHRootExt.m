...
@implementation NSObject (VHRootExt)
...
+(NSString *) deviceInfo{
    ...
    return [NSString stringWithFormat:@"iOS|%@;%@%@",type,systemName,systemVersion];
}

+ (NSString*) systemName{
    NSString *systemVersionStr = [[UIDevice currentDevice] systemVersion];
    NSString *uidevicestre=[NSString stringWithFormat:@"%@; IOS %@",[self deviceInfo], systemVersionStr];
    return uidevicestre;
}
