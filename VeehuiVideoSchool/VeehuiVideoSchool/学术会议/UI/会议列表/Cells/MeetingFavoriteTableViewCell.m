//
//  MeetingFavoriteTableViewCell.m
//  VeehuiVideoSchool
//
...
@interface MeetingFavoriteTableViewCell ()

@property (nonatomic, strong) MedicalVideoCategoryView* categoryView;

@end

@implementation MeetingFavoriteTableViewCell
...
- (void) segmentViewSelectedIndexChanged:(MedicalVideoClassifyEntryModel*) category{
    //跳转到分类会议视频列表
    [MeetingPageRouter entryMeetingReplayPage:category];
}
