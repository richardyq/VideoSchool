...
NSString* const MeetingDetailContentLoadedNotification = @"MeetingContentLoadedNotification";

@interface MeetingScheduleTableViewCell ()
...
- (void) setEntryModel:(EntryModel *)model{
    ...
    NSString *contentStr = [NSString stringWithFormat:@"<head><style>img{width:%f  !important;height:auto;}</style></head>%@",kScreenWidth - 50, meeting.schedule];
