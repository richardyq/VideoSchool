//
//  MedicalVideoStartRecommadCourseTableViewCell.m
//  VeehuiVideoSchool
//
...
@implementation MedicalVideoStartRecommadCourseTableViewCell

- (id) initWithCourseList:(MedicalVideoGroupInfoListModel*) courseList{
    self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MedicalVideoStartRecommadCourseTableViewCell"];
    if (self) {
